...
local Get_Files, res = https.request("https://raw.githubusercontent.com/STARK-VPS/Lucifer/Files_Lucifer/master/getfile.json")
if res == 200 then
...
local Get_Json, Res = https.request("https://raw.githubusercontent.com/STARK-VPS/Lucifer/Files_Lucifer/master/Files_Lucifer/"..File_Name)
if Res == 200 then
